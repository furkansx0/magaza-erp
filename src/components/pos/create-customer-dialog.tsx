...
import { CalendarIcon, Loader2, Save, User, Building2, Flag } from "lucide-react"
...
import { createDetailedCustomer } from "@/actions/pos/pos-actions"
...
export function CreateCustomerDialog({ open, onOpenChange, initialPhone, onSuccess }: CreateCustomerDialogProps) {
    ...
    const form = useForm<z.infer<typeof customerSchema>>({
        ...
        defaultValues: {
            ...
            birthday: "",
            specialDate: "",
            specialDateLabel: "Evlilik Yıldönümü",
            notes: "",
            consentSMS: true,
            consentEmail: true,
            gender: undefined,
    ...
    const onSubmit = async (values: z.infer<typeof customerSchema>) => {
        setLoading(true)
        try {
            const res = await createDetailedCustomer(values)
            if (res.success) {
